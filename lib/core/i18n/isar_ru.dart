...
part of 'isar_i18n.dart';

class IsarI18nRu implements IsarI18n {
  String get isarDbChoiceDefaultPathTopic => 'По умолчанию используется адрес';
  ...
  String get notWindowWarning => 'Невозможно изменить папку по умолчанию на платформе, отличной от Windows';
